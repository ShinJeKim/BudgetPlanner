...
<script type="text/javascript" src="/apps/resources/js/datepicker.js"></script>
<script type="text/javascript" src="/apps/resources/js/on.js"></script>
		...
		<div class="sub_menus">
			<ul>
				<li class="sub_menu">
					...
					<label class="sub_menu-label" for="daily"><a href="/apps/header.jsp">일별</a></label>
				</li>
				<li class="sub_menu">
				...
				<li class="sub_menu">
					...
					<label class="sub_menu-label" for="category"><a href="??">카테고리</a></label>
				</li>
			</ul>
		</div>
	</div>
